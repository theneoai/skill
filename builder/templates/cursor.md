...
When creating a skill, Cursor will ask:
...
Cursor: [Asks 6 elicitation questions]
User: [Answers questions]
Cursor: [Generates skill using API Integration template]
```
...
Cursor: [Runs 4-phase evaluation]
Cursor: "Score: 847/1000 (GOLD tier). Issues found:..."
```
...
Cursor: [Runs optimization loop]
Cursor: "Improved from 720 to 890 points. Changes:..."
```
...
```
~/.cursor/skills/skill-writer/templates/
```
...
Cursor uses different placeholder syntax:
...
- Include JSON metadata at the top
- Test with Cursor's specific format
