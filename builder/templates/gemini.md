...
When creating a skill, Gemini will ask:
...
Gemini: [Asks 6 elicitation questions]
User: [Answers questions]
Gemini: [Generates skill using API Integration template]
```
...
Gemini: [Runs 4-phase evaluation]
Gemini: "Score: 847/1000 (GOLD tier). Issues found:..."
```
...
Gemini: [Runs optimization loop]
Gemini: "Improved from 720 to 890 points. Changes:..."
```
...
```
~/.gemini/skills/skill-writer/templates/
```
